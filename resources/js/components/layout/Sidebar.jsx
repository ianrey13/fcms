      ...
      <NavLink
        ...
        className={({ isActive }) =>
          cn(
            ...
            isActive && isOpen && "before:absolute before:left-0 before:top-1/2 before:-translate-y-1/2 before:h-8 before:w-[3px] before:rounded-r-full before:bg-gradient-to-b before:from-blue-500 before:to-blue-600 before:shadow-lg before:shadow-blue-500/30"
          )
        }
      >
        {({ isActive }) => (
          <>
            <div className={cn(
              ...
              isActive && "after:absolute after:inset-0 after:bg-blue-500/10 after:rounded-lg after:scale-75 after:opacity-0 group-hover:after:opacity-100 after:transition-all"
            )}>
            ...
            {isOpen && (
              <span className={cn(
                ...
                isActive && "bg-gradient-to-r from-blue-600 to-blue-500 bg-clip-text text-transparent"
              )}>
                {item.name}
              </span>
            )}
      ...
      <button
        ...
        className={cn(
          ...
          isAnySubActive
            ...
            : "text-slate-600 dark:text-slate-400",
          isOpen ? "px-3 py-2.5 gap-3" : "justify-center p-2.5",
          isAnySubActive && isOpen && "before:absolute before:left-0 before:top-1/2 before:-translate-y-1/2 before:h-8 before:w-[3px] before:rounded-r-full before:bg-gradient-to-b before:from-blue-500 before:to-blue-600 before:shadow-lg before:shadow-blue-500/30"
        )}
      >
        <div className={cn(
          "relative flex items-center justify-center",
          isAnySubActive && "after:absolute after:inset-0 after:bg-blue-500/10 after:rounded-lg after:scale-75 after:opacity-0 group-hover:after:opacity-100 after:transition-all"
        )}>
          <item.icon className={cn(
            "h-[18px] w-[18px] flex-shrink-0 transition-all duration-200",
            isAnySubActive 
        ...
        {isOpen && (
          <>
            <span className={cn(
              ...
              isAnySubActive && "bg-gradient-to-r from-blue-600 to-blue-500 bg-clip-text text-transparent"
            )}>
              {item.name}
            </span>
            <ChevronRight
  ...
  return (
    <>
      ...
      >
        ...
        >
          <div className={cn("flex items-center", isOpen ? "gap-3" : "flex-col")}>
        ...
        <div className={cn("p-3", !isOpen && "flex justify-center")}>
          <Button
            ...
            className={cn(
              ...
              isOpen ? "justify-start px-3 py-2.5 gap-3" : "justify-center p-2.5 h-auto",
            )}
          >
            <LogOut className={cn(
